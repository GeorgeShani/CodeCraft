          ...
          <div className="p-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="space-y-1">
                  <span className="px-3 py-1 bg-blue-500/10 text-blue-400 rounded-lg text-xs font-medium">
                    {formatLanguageName(snippet.language)}
                  </span>
            ...
            <div className="space-y-4">
              ...
              <div className="relative group/code">
                ...
                <pre className="relative bg-black/30 rounded-lg p-4 overflow-hidden text-sm text-gray-300 font-jetbrains line-clamp-3">
                  {snippet.code}
                </pre>
              </div>
            </div>
