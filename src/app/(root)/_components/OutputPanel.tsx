  ...
  return (
    <div className="relative bg-[#181825] rounded-xl p-4 ring-1 ring-gray-800/50">
      ...
      <div className="relative">
        <div className="relative bg-[#1e1e2e]/50 backdrop-blur-sm border border-[#313244] rounded-xl p-4 h-[600px] overflow-auto text-sm">
          {isRunning ? (
            <RunningCodeSkeleton />
          ) : error ? (
            <div className="flex items-start gap-3 text-red-400">
              ...
              <div className="space-y-1">
                ...
                <pre className="whitespace-pre-wrap text-red-400/80 font-jetbrains">
                  {error}
                </pre>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <pre className="whitespace-pre-wrap text-gray-300 font-jetbrains">
                {output}
              </pre>
            </div>
          ) : (
